...
function levelbutton:draw()
	...
	if self.unlocked then
		...
		(#filetable[self.i].collectedcoins >= filetable[self.i].coins) then
			love.graphics.setColor(1, 1, 1, 150/255*fadecolor)
		...
		love.graphics.setColor(r, g, b, 200/255*fadecolor)
		...
		love.graphics.setColor(r, g, b, 100/255*fadecolor)
		...
		elseif (not filetable[self.i].goaltime and filetable[self.i].hightime) or  filetable[self.i].hightime <= filetable[self.i].goaltime then
			love.graphics.setColor(0, 255, 0, fadecolor)
		else
			love.graphics.setColor(1, 0, 0, fadecolor)
		end
		...
		love.graphics.setColor((100+self.value*150)/255, (100+self.value*150)/255, (100+self.value*150)/255, 200/255*fadecolor)
		...
		if #filetable[self.i].collectedcoins >= filetable[self.i].coins then
			...
			love.graphics.setColor(50/255, 50/255, 50/255, fadecolor)
		end
		...
		local r, g, b = 200/255, 200/255, 200/255
		...
		love.graphics.setColor(100/255, 100/255, 100/255, 100/255*fadecolor)
		love.graphics.draw(coinsbackimg, self.x+self.width/2, self.y)
