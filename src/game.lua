...
function game_draw()
	...
	love.graphics.setColor(1, 1, 1, 200/255*fadecolor)
	love.graphics.setFont(winwindowfont)
	...
	if pausemenutimer > 0 then
		...
		love.graphics.setColor(0, 0, 0, 200/255*fadecolor)
