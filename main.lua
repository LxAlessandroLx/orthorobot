...
function love.load()
	...
	menufont = love.graphics.newFont( "res/font/font.ttf", 40)
	helpfont = love.graphics.newFont( "res/font/font.ttf", 30)
	winwindowtitlefont = love.graphics.newFont( "res/font/font.ttf", 23)
	levelselectfont = love.graphics.newFont( "res/font/font.ttf", 20)
	winwindowfont = love.graphics.newFont( "res/font/font.ttf", 15)
	coinsfont = love.graphics.newFont( "res/font/font.ttf", 11)
	...
	logo = love.graphics.newImage("res/img/stabyourself.png")
	logoblood = love.graphics.newImage("res/img/stabyourselfblood.png")
	
	playerimg = love.graphics.newImage("res/img/player.png");playerimg:setFilter("nearest", "nearest")
	playerquad = {love.graphics.newQuad(0, 0, 20, 20, 40, 20), love.graphics.newQuad(20, 0, 20, 20, 40, 20)}
	
	coinimg = love.graphics.newImage("res/img/coin.png");coinimg:setFilter("nearest", "nearest")
	scanlineimg = love.graphics.newImage("res/img/scanlines.png");scanlineimg:setFilter("nearest", "nearest")
	
	textavatarimg = love.graphics.newImage("res/img/textavatar.png");textavatarimg:setFilter("nearest", "nearest")
	
	helptextimg = love.graphics.newImage("res/img/helptext.png");helptextimg:setFilter("nearest", "nearest")
	helpgoalimg = love.graphics.newImage("res/img/helpgoal.png");helpgoalimg:setFilter("nearest", "nearest")
	helpplayerimg = love.graphics.newImage("res/img/helpplayer.png");helpplayerimg:setFilter("nearest", "nearest")
	helpfswdimg = love.graphics.newImage("res/img/helpfswd.png");helpfswdimg:setFilter("nearest", "nearest")
	helpcursorimg = love.graphics.newImage("res/img/helpcursor.png");helpcursorimg:setFilter("nearest", "nearest")
	
	coinsbackimg = love.graphics.newImage("res/img/coinsback.png");coinsbackimg:setFilter("nearest", "nearest")
	yayimg = love.graphics.newImage("res/img/yay.png");yayimg:setFilter("nearest", "nearest")
	yaywonimg = love.graphics.newImage("res/img/yaywon.png");yaywonimg:setFilter("nearest", "nearest")
	
	clockimg = love.graphics.newImage("res/img/clock.png");clockimg:setFilter("nearest", "nearest")
	stepsimg = love.graphics.newImage("res/img/steps.png");stepsimg:setFilter("nearest", "nearest")
	warpsimg = love.graphics.newImage("res/img/warps.png");warpsimg:setFilter("nearest", "nearest")
	
	number1img = love.graphics.newImage("res/img/1.png");number1img:setFilter("nearest", "nearest")
	number2img = love.graphics.newImage("res/img/2.png");number2img:setFilter("nearest", "nearest")
	number3img = love.graphics.newImage("res/img/3.png");number3img:setFilter("nearest", "nearest")
	gosmallimg = love.graphics.newImage("res/img/gosmall.png");gosmallimg:setFilter("nearest", "nearest")
	gobigimg = love.graphics.newImage("res/img/gobig.png");gobigimg:setFilter("nearest", "nearest")
	
	winplayerimg = love.graphics.newImage("res/img/winplayer.png");winplayerimg:setFilter("nearest", "nearest")
	coinglowimg = love.graphics.newImage("res/img/coinglow.png");coinglowimg:setFilter("nearest", "nearest")
	
	ssssimg = love.graphics.newImage("res/img/ssss.png");ssssimg:setFilter("nearest", "nearest")
	accentimg = love.graphics.newImage("res/img/accent.png");accentimg:setFilter("nearest", "nearest")
	
	menumusic = love.audio.newSource("res/audio/menu_back.ogg", "stream")
	menumusic:setLooping(true)
	menumusic:setVolume(0.01)
	gamemusic = love.audio.newSource("res/audio/game_back.ogg", "stream")
	gamemusic:setLooping(true)
	stabsound = love.audio.newSource("res/audio/stab.ogg", "static")
	
	backsound = love.audio.newSource("res/audio/back.ogg", "static")
	proceedsound = love.audio.newSource("res/audio/proceed.ogg", "static")
	winningsound = love.audio.newSource("res/audio/winning.ogg", "static")
	coinsound = love.audio.newSource("res/audio/coin.ogg", "static")
